...
<div className={`pointer-events-none blur-2xl rounded-full bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 w-[200px] h-[200px] absolute z-0 transition-opacity duration-500 mix-blend-lighten ${visible ? 'opacity-70' : 'opacity:0'}`} style={{top: position.y - 150, left: position.x - 150}}/>
...
<div className='bg-gray-100 dark:bg-gray-700 rounded-full'>
  <img src={service.icon} alt="" className='max-w-20 bg-white dark:bg-gray-900 rounded-full m-2'/> 
</div>

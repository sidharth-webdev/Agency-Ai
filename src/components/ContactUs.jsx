...
const onSubmit = async (event) => {
    ...
    formData.append("access_key", "dd084f2d-69f3-4070-b3b2-ae80f8e059ad");
...
try {
  ...
  return (
    ...
    id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
      <Title title='Reach out of us' desc = 'From strategy to execution, we craft digital solutions that move your business forward.'/>
      ...
      onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full '>
        <div>
            ...
            <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
                ...
                <input name="name" placeholder='Enter your Name' className='w-full p-3 text-sm outline-none'required/>
            </div>
        </div>
        ...
        <div>
            ...
            <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
                ...
                <input name="email" placeholder='Enter your email' className='w-full p-3 text-sm outline-none'required/>
            </div>
        </div>
        ...
        <button type="submit" className='w-max flex gap-2 bg-primary text-white text-sm px-10 py-3 rounded-full cursor-pointer hover:scale-103 transition-all'>
            Submit <img src={assets.arrow_icon} alt="" className='w-2'/>
        </button>
      </motion.form>
    </motion.div>
  )
